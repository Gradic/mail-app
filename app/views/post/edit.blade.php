...
{{ Form::open(array('route' => array('post.store'), 'method' => 'post', 'class' => 'form-horizontal')) }}
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" class="form-control" id="sender" name="sender" value="{{ $post->sender }}">
      </div>
    </div>
    <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">Tema</label>
      <div class="col-lg-10">
        <input type="text" class="form-control" id="theme" name="theme" value="{{ $post->theme }}">
      </div>
    </div>
    <div class="form-group">
      <label for="textArea" class="col-lg-2 control-label">Tekstas</label>
      <div class="col-lg-10">
        <textarea class="form-control ckeditor rows="3" id="text" name="text">{{ $post->text }}</textarea>
        <div class="checkbox">
          <label>
